 ...
 *
 * <p>This is a best-effort read for an observability sidecar: any failure
 * (unreachable store, malformed payload, trace not yet indexed) yields
 * {@link Optional#empty()} and the triage proceeds without the trace.
 */
@Component
public class HttpTraceRepository implements TraceRepository {
    ...
    public HttpTraceRepository(AiOpsProperties properties, ObjectMapper objectMapper) {
